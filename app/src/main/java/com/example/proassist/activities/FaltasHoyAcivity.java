...
public class FaltasHoyAcivity extends AppCompatActivity implements TaskCompleted {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faltas_hoy_acivity);
    ...
    private void loadElements() {
        this.toolbar = findViewById(R.id.toolbarFaltasHoy);
        this.recyclerView = findViewById(R.id.recyclerFaltasHoy);
    ...
    private void setData() {
        new FaltaHoyService(FaltasHoyAcivity.this).execute("https://sanmigcea.000webhostapp.com/get-faltas-today.php");
        setSpinner();
    }
